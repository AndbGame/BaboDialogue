...
(Alias_CreatureRef01.getref() as actor).DeleteWhenAble()
(Alias_CreatureRef02.getref() as actor).DeleteWhenAble()
(Alias_CreatureRef03.getref() as actor).DeleteWhenAble()
(Alias_CreatureRef04.getref() as actor).DeleteWhenAble()
(Alias_CreatureRef05.getref() as actor).DeleteWhenAble()
