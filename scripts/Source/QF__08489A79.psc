...
Alias_Thug01.clear()
Alias_Thug02.clear()
(BaboSexController as BaboSexControllerManager).KidnapQuestStart(Thug01, Thug02, 0, BaboKidnapperLocationCave)
Utility.wait(7.0)
...
(BaboSexController as BaboSexControllerManager).KidnapQuestStart(ThugPost01, ThugPost02, 0, BaboKidnapperLocationCave)
Utility.wait(7.0)
(BaboKidnapEvent as BaboKidnapEvenScript).StartUptheEvent(10)
...
Alias_Thug04.clear()
Alias_VictimWoman.clear()
(BaboKidnapEvent as BaboKidnapEvenScript).FillKidnapperActors(None, None, Thug03, Thug04, None)
(BaboKidnapEvent as BaboKidnapEvenScript).FillVictimActors(VictimWoman, None, None)
(BaboKidnapEvent as BaboKidnapEvenScript).setthestage()
setstage(255)
;END CODE
...
Actor VictimWoman = Alias_VictimWoman.Getreference() as actor
Alias_VictimWoman.clear()
(BaboKidnapEvent as BaboKidnapEvenScript).FillKidnapperActors(None, None, ThugPost03, None, None)
(BaboKidnapEvent as BaboKidnapEvenScript).FillVictimActors(VictimWoman, None, None)
(BaboKidnapEvent as BaboKidnapEvenScript).setthestage()
setstage(255)
;END CODE
...
Actor ThugPost01 = Alias_ThugPost01.Getreference() as actor
Alias_ThugPost01.clear()
(BaboSexController as BaboSexControllerManager).KidnapQuestStart(ThugPost01, None, 0, BaboKidnapperLocationCave)
Utility.wait(7.0)
(BaboKidnapEvent as BaboKidnapEvenScript).StartUptheEvent(10)
...
Actor VictimWoman = Alias_VictimWoman.Getreference() as actor
Alias_VictimWoman.clear()
(BaboKidnapEvent as BaboKidnapEvenScript).FillKidnapperActors(None, None, ThugPost03, ThugPost04, None)
(BaboKidnapEvent as BaboKidnapEvenScript).FillVictimActors(VictimWoman, None, None)
(BaboKidnapEvent as BaboKidnapEvenScript).setthestage()
setstage(255)
;END CODE
